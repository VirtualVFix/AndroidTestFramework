...
class OctaneCVTest(OctaneCV):
    """ Test class for recognition debug """
    
    def __init__(self):
        super(OctaneCVTest, self).__init__()
        self.image_list = []
    ...
    def drawText(self, image, fontScale = 0.8, color = (255,255,255)):
        i = 20
...
#                frame = np.copy(image)
                ...
                # get digit                
#                digit = self.getDigitDebug(frame)
                ...
                self.drawText(self.DEBUG_DATA['crop_image'], color = (255,255,255))
