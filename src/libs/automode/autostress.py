...
class AutoBenchmarks(BenchmarkSheet):
    ...
    def prepareSheet(self):
        """ prepare sheet """
        self.logger.info('Preparing spreasdsheet...')
        ...
        if self.sheet_new_column:
            ...
            self.logger.newline()
            self.logger.warn('NEW COLUMN WAS NOT CREATED. PLEASE NOTE, VALUES {}IN "{}" COLUMN COULD BE REWRITTEN !'
        ...
        if len(self.header_config) == 0: raise SpreadsheetError('Sheet header is not defined !')
        # update header 
